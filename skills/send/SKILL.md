...
3. Post the message verbatim, with the text on stdin via a heredoc:
   ...
   ```sh
   explain-selection send --pid <pid> --text - <<'EXPLAIN_SELECTION_MESSAGE'
   <message text>
   EXPLAIN_SELECTION_MESSAGE
   ```
